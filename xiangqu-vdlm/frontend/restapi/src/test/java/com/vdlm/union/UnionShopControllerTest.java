...
//	}
	...
	public void listTest() throws Exception {
		...
		String sign = MD5Util.MD5Encode("page="+page+"&req_date="+date+"&size="+size+"&union_id=" + unionId + "19r4e7s12356297t07eda94cf7b35193", "UTF-8");
		MvcResult result = mockMvc.perform(
				get("/partner/p/list")
