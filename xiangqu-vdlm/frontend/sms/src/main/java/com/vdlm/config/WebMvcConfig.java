...
import com.vdlm.sms.Scanned;

@Configuration
@Import(ApplicationConfig.class)
@ImportResource("classpath:META-INF/applicationContext-sms.xml")
@ComponentScan(basePackageClasses = Scanned.class, includeFilters = {@Filter(Controller.class),@Filter(Component.class)}, useDefaultFilters = false)
